                      ...
                      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        {galleryImages.map(img => (
                          <motion.div
                            key={img.id}
                            whileHover={{ y: -5 }}
                            className="border rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300"
                          >
                            ...
                            <div className="p-4 space-y-3">
                              ...
                              <div className="flex gap-3 mt-3">
                                ...
                                <button
                                  className="flex items-center justify-center bg-gray-100 px-3 py-2.5 rounded-lg hover:bg-gray-200 transition-colors"
                                >
